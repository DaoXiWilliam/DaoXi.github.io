...
function(e) {
    ...
    h.prototype = {
        ...
        open: function(i) {
            ...
            t.bgOverlay || (t.bgOverlay = C("bg").on("click" + u,
            function() {
                t.close()
            }), t.wrap = C("wrap").attr("tabindex", -1).on("click" + u,
            function(e) {
            ...
            b("BeforeOpen"),
            t.st.showCloseBtn && (t.st.closeBtnInside ? (y(c,
            function(e, t, i, n) {
                i.close_replaceWith = w(n.type)
            }), r += " mfp-close-btn-in") : t.wrap.append(w())),
            ...
            t.st.enableEscapeKey && n.on("keyup" + u,
            function(e) {
        ...
        appendContent: function(e, i) {
            t.content = e,
            e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[i] ? t.content.find(".mfp-close").length || t.content.append(w()) : t.content = e: t.content = "",
            b("BeforeAppend"),
    ...
    e.fn.magnificPopup = function(i) {
        ...
        if ("string" == typeof i) {
            if ("open" === i) {
                ...
                r.items ? o = r.items[a] : (o = n, r.delegate && (o = o.find(r.delegate)), o = o.eq(a)),
                t._openClick({
                    mfpEl: o
                },
                n, r)
    ...
    var k, _, P, S = "inline",
    T = function() {
        P && (_.after(P.addClass(k)).detach(), P = null)
    };
            ...
            getInline: function(i, n) {
                if (T(), i.src) {
                    ...
                    if (r.length) {
                        ...
                        a && a.tagName && (_ || (_ = C(k = o.hiddenClass), k = "mfp-" + k), P = r.after(_).detach().removeClass(k)),
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            getImage: function(i, n) {
                ...
                i),
                t.resizeImage(),
                i.hasSize ? (B && clearInterval(B), i.loadError ? (n.addClass("mfp-loading"), t.updateStatus("error", s.tError.replace("%url%", i.src))) : (n.removeClass("mfp-loading"), t.updateStatus("ready")), n) : (t.updateStatus("loading"), i.loading = !0, i.hasSize || (i.imgHidden = !0, n.addClass("mfp-loading"), t.findImageSize(i)), n)
            }
        }
    }),
        ...
        proto: {
            initZoom: function() {
                ...
                if (i.enabled && t.supportsTransition) {
                    ...
                    function() {
                        if (t._allowZoom()) {
                            if (clearTimeout(o), t.content.css("visibility", "hidden"), !(e = t._getItemToZoom())) return void d(); (r = c(e)).css(t._getOffset()),
                            t.wrap.append(r),
            ...
            _getOffset: function(i) {
                ...
                return (void 0 === L && (L = void 0 !== document.createElement("p").style.MozTransform), L) ? s["-moz-transform"] = s.transform = "translate(" + o.left + "px," + o.top + "px)": (s.left = o.left, s.top = o.top),
                s
            }
        }
    });
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                !!i && !!i.enabled && (r += " mfp-gallery", y(d + o,
                function() {
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var e = t.st.retina,
                    i = e.ratio; (i = isNaN(i) ? i() : i) > 1 && (y("ImageHasSize." + N,
                    function(e, t) {
                        t.img.css({
