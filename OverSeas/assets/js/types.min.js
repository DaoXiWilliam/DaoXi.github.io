    ...
    return function(t) {
        ...
        o = function() {
            function t(e, s) { (function t(e, s) {
                    if (! (e instanceof s)) throw TypeError("Cannot call a class as a function")
                })(this, t),
    ...
    function(t, e, s) {
        ...
        a = function() {
            ...
            return r(t, [{
                key: "load",
                value: function(t, e, s) {
                    if ("string" == typeof s ? t.el = document.querySelector(s) : t.el = s, t.options = i({},
                    o.
